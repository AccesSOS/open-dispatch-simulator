...
| --- | --- | --- | --- |
| Open ISES Project EMD Guide Cards v0.26.2 (2008) | GFDL-1.2-or-later (verified in the PDF) | `us-openises-emd` | **All 34 interrogation cards digitized** (M1–M17, T1–T10, C1–C6, H2/H5), trilingual. **Instruction cards** now unblocked by schema v0.3 (`scripts`): I1 (AED), I2/I3/I4 (adult/child/infant CPR) and I5/I6/I7 (adult/child/infant choking) are live as interactive scripts, with C1/C2 routing by age; I8 (childbirth), I9/I10 (airway control) and H1/H3/H4 remain. Source: archive.org `files-all/cards911.zip`. |
